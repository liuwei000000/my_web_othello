	...
	if  (nt[BLACK] == nt[WHITE]) {
			...
			(playerTypeTable[WHITE] == 'human' && (nt[WHITE] > nt[BLACK])) )
		{
			if (win_sum > 50) {
				...
				$('#console').html('<span style="color:#F00;"><strong>电子书阅读</strong>：</span><a target="new" href="success/book_cn_1.02.pdf">黑白棋指南</a>,<a target="new" href="success/book_en.pdf">Othello （en）</a>, <a target="new" href="success/faster.pdf">奥赛乐技巧速成</a>, <a target="new" href="success/game.pdf">游戏编程</a><br/><strong>ios下载方法请自行研究</strong>');
			} else if(win_sum > 40) {
				msg = '您赢了！ 您打败了全国<span style="color:#F00;">' + (fens + 50).toFixed(1) + '%</span>的选手，关闭后，获得三本电子书';
				$('#console').html('<span style="color:#F00;"><strong>电子书阅读</strong>：</span><a target="new" href="success/book_cn_1.02.pdf">黑白棋指南</a>,<a target="new" href="success/book_en.pdf">Othello（en）</a>, <a target="new" href="success/faster.pdf">奥赛乐技巧速成</a><br/><strong>ios下载方法请自行研究</strong>');
			} else if(win_sum > 25) {
				msg = '您赢了！ 您打败了全国<span style="color:#F00;">' + (fens + 50).toFixed(1) + '%</span>的选手，关闭后，获得两本电子书';
				$('#console').html('<span style="color:#F00;"><strong>电子书阅读</strong>：</span><a target="new" href="success/book_cn_1.02.pdf">黑白棋指南</a>,<a target="new" href="success/book_en.pdf">Othello（en）</a><br/><strong>ios下载方法请自行研究</strong>');
			} else {
				msg = '您赢了！ 您打败了全国<span style="color:#F00;">' + (fens + 50).toFixed(1) + '%</span>的选手，关闭后，获得一本电子书';
				$('#console').html('<span style="color:#F00;"><strong>电子书阅读</strong>：</span><a target="new" href="success/book_cn_1.02.pdf">黑白棋指南</a><br/><strong>ios下载方法请自行研究</strong>');
			}
		} else {
